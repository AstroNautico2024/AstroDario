...
export const reseñasProductosController = {
  ...
  getAll: async (req, res) => {
    try {
      const reseñas = await reseñasProductosModel.getAll();
...
export default {
  reseñasProductos: reseñasProductosController,
  reseñasServicios: reseñasServiciosController,
  reseñasGenerales: reseñasGeneralesController
};